...
router = APIRouter(
    dependencies=[
        Depends(require_feature("ejercicios")),
        Depends(require_scope_gestion("ejercicios:read")),
    ]
)
...
async def api_upload_exercise_video(
    ...
    name: str = "",
    _w=Depends(require_scope_gestion("ejercicios:write")),
    ...
    try:
        ...
        max_bytes = int(
            os.environ.get("MAX_EXERCISE_VIDEO_BYTES", str(50 * 1024 * 1024))
        )
