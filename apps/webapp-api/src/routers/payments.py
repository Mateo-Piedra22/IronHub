...
from src.dependencies import get_db, get_pm, require_gestion_access, require_owner
from src.utils import _circuit_guard_json, _apply_change_idempotent, _filter_existing_columns
