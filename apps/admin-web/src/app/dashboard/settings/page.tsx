    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-neutral-400 mt-1">Configuración global del sistema</p>
            </div>
                        ...
                        <div className="grid gap-4 max-w-lg">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    disabled
                                />
                                <p className="text-xs text-neutral-500 mt-1">Configurado via variable de entorno</p>
                            </div>
                            <div>
                ...
                {activeTab === 'security' && (
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-neutral-500 text-sm">Funcionalidad próximamente</p>
                        </div>
                    </div>
                )}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <label className="flex items-center gap-3">
                                ...
                                <span className="text-neutral-300">Notificar vencimientos próximos</span>
                            </label>
                            <label className="flex items-center gap-3">
                                <input type="checkbox" defaultChecked className="w-4 h-4" />
                                <span className="text-neutral-300">Notificar nuevos gimnasios</span>
                            </label>
                            <label className="flex items-center gap-3">
                                <input type="checkbox" className="w-4 h-4" />
                                <span className="text-neutral-300">Notificar errores críticos por email</span>
                            </label>
                        </div>
                    </div>
                )}
