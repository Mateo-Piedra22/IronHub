    ...
    const leftPanelContent = (
        <div className="flex flex-col h-full font-mono text-sm">
            <Link href="/" className="border-b border-[#1a1a2e]/10 pb-5 mb-6 block group hover:border-[#1a1a2e]/30 transition-colors">
                <div className="text-[10px] opacity-40 tracking-[0.2em] mb-3">[ GESTIÓN DE GIMNASIOS ]</div>
                <div className="flex items-center gap-3 mb-2">
                    <Image
                        ...
                        priority
                    />
                    <div className="text-2xl font-bold tracking-tighter leading-none">IRONHUB</div>
                </div>
            ...
            <div className="border-t border-current pt-4 mt-6 space-y-3">
                ...
                <Link
                    href="https://app.ironhub.motiona.xyz"
    ...
    const rightPanelContent = (
        <div className="flex flex-col h-full font-mono text-sm">
            ...
            <div className="text-[10px] opacity-40 mt-6 pt-4 border-t border-current leading-relaxed">
                Plataforma profesional de gestión de gimnasios desarrollada por MotionA.
            </div>
        </div>
    );
