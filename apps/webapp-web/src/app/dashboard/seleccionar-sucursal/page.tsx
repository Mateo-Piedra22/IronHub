...
export default function DashboardSeleccionarSucursalPage() {
            ...
            <div className="w-full max-w-lg rounded-2xl border border-slate-800/60 bg-slate-900/40 backdrop-blur-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-400">Necesitás seleccionar una sucursal para ver métricas y operar.</p>
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-sm text-slate-400">No hay sucursales disponibles.</div>
                ) : (
