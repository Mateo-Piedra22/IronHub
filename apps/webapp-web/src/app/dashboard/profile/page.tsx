...
export default function ProfilePage() {
    ...
    if (!profile) {
        return (
            <div className="flex items-center justify-center h-64">
                <p className="text-neutral-500">No se pudo cargar el perfil</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 py-6">
            <div>
                ...
                <p className="text-neutral-400 mt-1">Información de tu cuenta</p>
            </div>
            ...
            >
                <div className="flex items-center gap-4">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-iron-500 to-iron-700 flex items-center justify-center text-3xl font-display font-bold text-white shadow-glow-md">
                        {getInitials(profile.nombre)}
                    </div>
                    <div>
                        <h2 className="text-xl font-semibold text-white">{profile.nombre}</h2>
                        <p className="text-neutral-400">DNI: {profile.dni || '-'}</p>
            ...
            <div className="grid gap-4">
                ...
                >
                    <h3 className="text-sm font-medium text-neutral-400 mb-4">Información de Contacto</h3>
                ...
                <motion.div
                    ...
                    className="glass-card p-4"
                >
                    <h3 className="text-sm font-medium text-neutral-400 mb-4">Plan y Membresía</h3>
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-lg bg-neutral-800 flex items-center justify-center">
                            ...
                            <div>
                                <div className="text-xs text-neutral-500">Plan Actual</div>
                        ...
                        {profile.fecha_proximo_vencimiento && (
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-xs text-neutral-500">Próximo Vencimiento</div>
