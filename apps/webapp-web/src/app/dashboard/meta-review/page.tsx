...
export default function MetaReviewOwnerPage() {
        ...
        <div className="space-y-6">
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-400 mt-1">Herramientas para grabar videos de revisión (solo dueño).</p>
                </div>
            ...
            <div className="card p-4 space-y-4">
                <div className="flex items-center justify-between gap-3">
                    ...
                    <Button
                        ...
                        onClick={() => copy('Video 1: Enviar mensaje desde IronHub y mostrar recepción en WhatsApp.')}
                    >
                        Copiar guion
                    </Button>
                </div>
            ...
            <div className="card p-4 space-y-4">
                <div className="flex items-center justify-between gap-3">
                    ...
                    <Button
                        variant="ghost"
                        leftIcon={<Copy className="w-4 h-4" />}
                        onClick={() => copy('Video 2: Crear plantilla desde IronHub y mostrarla listada/estado en Health.')}
                    >
                        Copiar guion
                    </Button>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                    <Button variant="secondary" onClick={runCreateTemplate} disabled={creating} leftIcon={creating ? <Loader2 className="w-4 h-4 animate-spin" /> : undefined}>
            ...
            {lastOutput ? (
                <div className="card p-4">
                    <div className="text-white font-semibold mb-2">Última respuesta</div>
                    <pre className="text-xs text-slate-300 overflow-x-auto whitespace-pre-wrap">{JSON.stringify(lastOutput, null, 2)}</pre>
                </div>
            ) : null}
        </div>
    );
