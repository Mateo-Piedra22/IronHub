...
export default function GestionLayout({
    ...
    return (
        <div className="min-h-screen bg-neutral-950">
            ...
            <header className="fixed top-0 left-0 right-0 z-40 h-16 glass border-b border-neutral-800/50">
                <div className="h-full flex items-center justify-between px-4 lg:px-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="lg:hidden p-2 rounded-lg text-neutral-400 hover:text-white hover:bg-neutral-800/50 transition-colors"
                        ...
                        <Link href="/gestion/usuarios" className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-iron-500 to-iron-700 flex items-center justify-center shadow-glow-sm">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            disabled={loggingOut}
                            className="p-2 rounded-lg text-neutral-400 hover:text-danger-400 hover:bg-danger-500/10 transition-colors disabled:opacity-50"
                            title="Cerrar sesión"
                        >
                ...
                {mobileMenuOpen && (
                    <>
                        ...
                        <motion.aside
                            ...
                            className="fixed top-0 left-0 bottom-0 z-50 w-72 bg-neutral-900 border-r border-neutral-800 lg:hidden"
                        >
                            <div className="h-full flex flex-col">
                                {/* Header */}
                                <div className="h-16 flex items-center justify-between px-4 border-b border-neutral-800">
                                    <div className="flex items-center gap-3">
                                        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-iron-500 to-iron-700 flex items-center justify-center">
                                            <Dumbbell className="w-4 h-4 text-white" />
                                        </div>
